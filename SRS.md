...
**Scope.** These 28 entries are the v2.0.0 MVP boundary per
...
| 2026-08-01 | 1.21.5 | v2.0.0 requirement append -- functional requirements (Phase 5, `prd-v2.md` FR-22) | Appended FR-10 through FR-37 (28 entries) covering the v2.0.0 MVP boundary. 27 map to a numbered requirement in `docs/phase-0-requirements/prd-v2.md`; FR-37 (`register-mcp`/`unregister-mcp`) has no PRD number and is carried from `hld_v2.md` ADR-019 because `product-sequencing-v2.md` section 2c makes it mandatory v2.0.0 scope. PRD FR-19 deliberately not carried -- deferred to v2.1. Nothing above FR-9 was edited or removed. All 28 are DESIGNED, NOT BUILT except FR-27 (plugin schema spike, complete). | Done |
