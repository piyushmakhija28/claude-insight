...
2. **ADR-020 Path C has no owner in the library, new agents included.** The one-shot verification at `hld_v2.md:773` is a measurement task, not an MCP-engineering task. Nothing delivered addresses it.
