...
by ADR-019, HLD cross-NFR check confirmed). NFR-4 -> Workstream A, 25-capability disposition
cross-check (unchanged). NFR-5 -> Workstream D, 3 Gherkin-backed lifecycle tests plus a 4th
