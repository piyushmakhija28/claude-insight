...
| 42 | `tool-usage-optimization-policy.md` | CONTRADICTED | No distinct point. Shares row 41's `read_opt.py` / `grep_opt.py` registration while its own text claims "NO DUPLICATION" | delete | OAQ 2 row 15 | MEASURED |
