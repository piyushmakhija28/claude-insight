...
class DaemonManager:
    def __init__(self):
        ...
        # Known daemons (with relative paths from memory_dir)
        self.daemons = {
            'context-daemon': '01-sync-system/context-management/context-daemon-hybrid.py',
            'session-auto-save-daemon': '01-sync-system/session-management/session-auto-save-daemon.py',
            'preference-auto-tracker': '01-sync-system/user-preferences/preference-auto-tracker.py',
            'skill-auto-suggester': '03-execution-system/07-recommendations/skill-auto-suggester.py',
            'commit-daemon': '03-execution-system/09-git-commit/commit-daemon.py',
            'session-pruning-daemon': '01-sync-system/session-management/session-pruning-daemon.py',
            'pattern-detection-daemon': '01-sync-system/pattern-detection/pattern-detection-daemon.py',
            'failure-prevention-daemon': '03-execution-system/failure-prevention/failure-prevention-daemon-smart.py',
            'token-optimization-daemon': '03-execution-system/06-tool-optimization/token-optimization-daemon.py',
            'health-monitor-daemon': 'utilities/health-monitor-daemon.py'
        }
