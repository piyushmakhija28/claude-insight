...
def trigger_auto_commit(project_dir, event="manual", push=True):
    ...
    print("\n" + "=" * 70)
    print("[ROCKET] AUTO-COMMIT TRIGGER")
    print("=" * 70)
    print(f"\nEvent: {event}")
