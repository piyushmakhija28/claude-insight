...
class ToolCallInterceptor:
    ...
    def optimize_bash(self, params):
        ...
        if is_structure_cmd:
            ...
            suggestions.append("🌳 Optimization: Use 'find . -maxdepth 2 -type d' instead for better structure view")
            # Don't auto-replace, just suggest (tree not available in Git Bash)
            # optimized = "find . -maxdepth 2 -type d ! -path '*/\\.*' | sort"
