...
class Level3JiraWorkflow:
    ...
    def step5_link_pr_and_transition(
        self,
        jira_issue_key: str,
        pr_url: str,
        pr_number: int,
