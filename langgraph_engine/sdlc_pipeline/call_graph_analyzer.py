    ...
    try:
        ...
        if graph is None:
            return {
                ...
                "failure_reason": "build_call_graph() returned None for root: " + str(project_root),
            }
...
def refresh_call_graph_if_stale(state, project_root):
    ...
    The call_graph_stale flag is set True by step4_implementation_node
    ...
    for key in ("step4_pre_change_graph", "step1_impact_analysis", "pre_analysis_result"):
        snap = state.get(key)
