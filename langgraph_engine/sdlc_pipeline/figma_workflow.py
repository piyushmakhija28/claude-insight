...
class Level3FigmaWorkflow:
    ...
    def step1_extract_components(self, file_key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning("[FigmaWorkflow] step1_extract_components failed: %s", exc)
            return {"success": False, "reason": str(exc)}

    def step1_extract_design_tokens(self, file_key: str, node_ids: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning("[FigmaWorkflow] step1_extract_design_tokens failed: %s", exc)
            return {"success": False, "reason": str(exc)}

    def step5_design_review(self, file_key: str, implementation_summary: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning("[FigmaWorkflow] step5_design_review failed: %s", exc)
            return {"success": False, "reason": str(exc)}
    ...
    def step4_implementation_started(
        self,
        file_key: str,
    ...
    def step6_implementation_complete(
        self,
        file_key: str,
        pr_number: int = 0,
        pr_url: str = "",
